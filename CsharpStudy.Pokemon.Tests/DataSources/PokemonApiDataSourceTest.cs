...
using CsharpStudy.Pokemon.DataSources;
using Moq;
using NUnit.Framework;

namespace CsharpStudy.Pokemon.Tests.DataSources;
...
public class PokemonApiDataSourceTest
{
    ...
    public async Task PokemonApiDataSource_Test()
    {
        ...
        //
        // mock.Setup(client => client.GetAsync($"https://pokeapi.co/api/v2/pokemon/ditto"))
        //     .Returns(dittoMockData);
        ...
        Assert.That(pokemon.sprites.other.OfficialArtwork?.front_default,
            Is.EqualTo(
                "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/132.png"));
    }

    private const string dittoMockData = @"{
  ""abilities"": [
    {
      ""ability"": {
        ""name"": ""limber"",
