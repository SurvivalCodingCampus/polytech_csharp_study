...
// 이 파일에 모든 DTO 클래스를 포함하거나, 필요에 따라 별도의 파일로 분리할 수 있습니다.
...
public class HeldItemDto
{
    ...
    [JsonProperty("version_details")] public List<VersionDetailDto>? VersionDetails { get; set; }
}
...
public class PastAbilityDetailDto
{
    [JsonProperty("ability")] public NamedApiResourceDto? Ability { get; set; }
...
{
    [JsonProperty("abilities")] public List<PastAbilityDetailDto>? Abilities { get; set; }
...
{
    [JsonProperty("dream_world")] public DreamWorldDto? DreamWorld { get; set; }

    [JsonProperty("home")] public HomeDto? Home { get; set; }

    [JsonProperty("official-artwork")] public OfficialArtworkDto? OfficialArtwork { get; set; }

    [JsonProperty("showdown")] public ShowdownDto? Showdown { get; set; }
}
...
public class RedBlueDto
{
    ...
    [JsonProperty("back_gray")] public string? BackGray { get; set; }

    [JsonProperty("back_transparent")] public string? BackTransparent { get; set; }

    [JsonProperty("front_default")] public string? FrontDefault { get; set; }

    [JsonProperty("front_gray")] public string? FrontGray { get; set; }

    [JsonProperty("front_transparent")] public string? FrontTransparent { get; set; }
}
...
{
    [JsonProperty("red-blue")] public RedBlueDto? RedBlue { get; set; }

    [JsonProperty("yellow")] public YellowDto? Yellow { get; set; }
}
...
{
    [JsonProperty("crystal")] public CrystalDto? Crystal { get; set; }

    [JsonProperty("gold")] public GoldDto? Gold { get; set; }

    [JsonProperty("silver")] public SilverDto? Silver { get; set; }
}
...
{
    [JsonProperty("emerald")] public EmeraldDto? Emerald { get; set; }

    [JsonProperty("firered-leafgreen")] public FireredLeafgreenDto? FireredLeafgreen { get; set; }

    [JsonProperty("ruby-sapphire")] public RubySapphireDto? RubySapphire { get; set; }
}
...
{
    [JsonProperty("diamond-pearl")] public DiamondPearlDto? DiamondPearl { get; set; }

    [JsonProperty("heartgold-soulsilver")] public HeartgoldSoulsilverDto? HeartgoldSoulsilver { get; set; }

    [JsonProperty("platinum")] public PlatinumDto? Platinum { get; set; }
}
...
{
    [JsonProperty("animated")] public AnimatedDto? Animated { get; set; }
...
{
    [JsonProperty("black-white")] public BlackWhiteDto? BlackWhite { get; set; }
}
...
public class GenerationVIDto
{
    ...
    [JsonProperty("x-y")] public XYDto? XY { get; set; }
}
...
{
    [JsonProperty("icons")] public IconsDto? Icons { get; set; }

    [JsonProperty("ultra-sun-ultra-moon")] public UltraSunUltraMoonDto? UltraSunUltraMoon { get; set; }
}
...
{
    [JsonProperty("generation-i")] public GenerationIDto? GenerationI { get; set; }

    [JsonProperty("generation-ii")] public GenerationIIDto? GenerationII { get; set; }

    [JsonProperty("generation-iii")] public GenerationIIIDto? GenerationIII { get; set; }

    [JsonProperty("generation-iv")] public GenerationIVDto? GenerationIV { get; set; }

    [JsonProperty("generation-v")] public GenerationVDto? GenerationV { get; set; }

    [JsonProperty("generation-vi")] public GenerationVIDto? GenerationVI { get; set; }

    [JsonProperty("generation-vii")] public GenerationVIIDto? GenerationVII { get; set; }

    [JsonProperty("generation-viii")] public GenerationVIIIDto? GenerationVIII { get; set; }
}
...
public class SpritesDto
{
    ...
    [JsonProperty("versions")] public VersionsDto? Versions { get; set; }
}
...
public class PokemonDto
{
    ...
    [JsonProperty("cries")] public CriesDto? Cries { get; set; }

    [JsonProperty("forms")] public List<NamedApiResourceDto>? Forms { get; set; }

    [JsonProperty("game_indices")] public List<GameIndexDto>? GameIndices { get; set; }

    [JsonProperty("height")] public int? Height { get; set; }

    [JsonProperty("held_items")] public List<HeldItemDto>? HeldItems { get; set; }
    ...
    [JsonProperty("moves")] public List<MoveDto>? Moves { get; set; }

    [JsonProperty("name")] public string? Name { get; set; }

    [JsonProperty("order")] public int? Order { get; set; }

    [JsonProperty("past_abilities")] public List<PastAbilityDto>? PastAbilities { get; set; }

    [JsonProperty("past_types")] public List<object>? PastTypes { get; set; }
    ...
    [JsonProperty("types")] public List<TypeDto>? Types { get; set; }
