...
public class MainClass //거래 내역
{
    ...
    public static void Main(string[] args)
    {
       ...
       // 5. 밀라노에 거래자가 있는가?
      bool MilanTrader = transactions.Any(transaction => transaction.Trader.City == "Milan");
       Console.WriteLine(MilanTrader);
       Console.WriteLine("======================");
       ...
       int MaxValue = transactions.Select(transaction => transaction.Value)
        ...
        int MinValue = transactions.Select(transaction => transaction.Value)
